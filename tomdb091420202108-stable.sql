...
--
CREATE DATABASE IF NOT EXISTS `id13360783_db_movie` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `id13360783_db_movie`;
...
(6, '20200423040944', 'VqeqaweXBV0', 'https://yourmomrocks.files.wordpress.com/2013/04/the-curious-case-of-benjamin-button-for-your-consideration.png', 'The Curious Case of Benjamin Button', '2008', '7.8', 'Drama', 'Brad Pitt, Cate Blanchett, Tilda Swinton', 'Tells the story of Benjamin Button, a man who starts aging backwards with consequences.', 'https://paybitly.pw/Or7GL4p1', 'Size: 1.6gb'),
(7, '20200423111005', '_DJEzZk2pc', 'http://yesofcorsa.com/wp-content/uploads/2019/01/Joker-2019-Wallpaper-For-IPhone.jpg', 'Joker', '2019', '8.5', 'Crime', 'Joaquin Phoenix, Robert De Niro, Zazie Beetz', 'In Gotham City, mentally troubled comedian Arthur Fleck is disregarded and mistreated by society. He then embarks on a downward spiral of revolution and bloody crime. This path brings him face-to-face with his alter-ego: the Joker.', 'https://paybitly.pw/zdmjs', '480p'),
...
(14, '20200721014336', '1d4DACwz49o', 'https://m.media-amazon.com/images/M/MV5BMTkwOTQ4OTg0OV5BMl5BanBnXkFtZTgwMzQyOTM0OTE@._V1_UX182_CR0,0,182,268_AL_.jpg', 'Train to Busan', '2016', '7.5', 'Horror', 'Yoo Gong, Yu-mi Jung, Dong-seok Ma', 'While a zombie virus breaks out in South Korea, passengers struggle to survive on the train from Seoul to Busan.', 'https://dl.tomdb.xyz/busan2016', 'Farsi'),
